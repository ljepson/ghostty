...
typedef enum {
  ...
  GHOSTTY_ACTION_COPY_LAST_FAILED_OUTPUT,
  GHOSTTY_ACTION_NAVIGATE_COMMAND,
  GHOSTTY_ACTION_DRIFT_ATTACH_NEXT,
  GHOSTTY_ACTION_FAMILIAR_SPEAK,
  GHOSTTY_ACTION_DRIFT_NEW_TAB,
  GHOSTTY_ACTION_CLOSE_TAB_KILL_DRIFT,
