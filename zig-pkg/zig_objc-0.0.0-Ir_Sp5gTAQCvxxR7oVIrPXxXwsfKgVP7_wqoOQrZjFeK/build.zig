...
pub fn addAppleSDK(b: *std.Build, m: *std.Build.Module) !void {
    ...
    const path = gop.value_ptr.* orelse switch (target.os.tag) {
        ...
        .macos => "/Applications/Xcode.app/Contents/Developer/Platforms/MacOS.platform/Developer/SDKs/MacOS26.4.sdk",
        .ios => "/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.4.sdk",
        .tvos => "/Applications/Xcode.app/Contents/Developer/Platforms/AppleTVOS.platform/Developer/SDKs/AppleTVOS26.4.sdk",
        .watchos => "/Applications/Xcode.app/Contents/Developer/Platforms/WatchOS.platform/Developer/SDKs/WatchOS26.4.sdk",
        else => "/Applications/Xcode.app/Contents/Developer/Platforms/MacOS.platform/Developer/SDKs/MacOS26.4.sdk",
    };
